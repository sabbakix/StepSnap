...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  startAutoRecord: () => ipcRenderer.invoke('autorecord:start'),
  stopAutoRecord: () => ipcRenderer.invoke('autorecord:stop'),
  onAutoRecordStep: (cb) => ipcRenderer.on('autorecord:step', (e, payload) => cb(payload)),
